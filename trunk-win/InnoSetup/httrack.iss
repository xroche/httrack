...
Root: HKCU; Subkey: "AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Current"; ValueType: string; ValueData: "{app}\html\server\sfx\finished.wav"; Flags: uninsdeletekey noerror; Tasks: regfiles
Root: HKCU; Subkey: "AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Default"; ValueType: string; ValueData: "{app}\html\server\sfx\finished.wav"; Flags: uninsdeletekey noerror; Tasks: regfiles
...
Root: HKU; Subkey: ".DEFAULT\AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Current"; ValueType: string; ValueData: "{app}\html\server\sfx\finished.wav"; Flags: uninsdeletekey noerror; Tasks: regfiles
Root: HKU; Subkey: ".DEFAULT\AppEvents\Schemes\Apps\WinHTTrack\MirrorStarted\.Default"; ValueType: string; ValueData: "{app}\html\server\sfx\finished.wav"; Flags: uninsdeletekey noerror; Tasks: regfiles
