...
.I \-#L
cap. The reason is in the log file, and what was mirrored before the abort is
kept. This is the process exit status, unrelated to the engine's own
.I exit_xh
value, which uses 2 for something else.
.IP "1, 255"
.B httrack
