...
/* Write the user's --assume type for fil into s, of capacity ssize (NUL
   included); a rule value too long for s is clipped, not fatal. Returns 1 if a
   rule matched, s then being the type, possibly empty ("--assume cgi="). */
