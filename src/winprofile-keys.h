...
static const winprofile_key_t winprofile_keys[WINPROFILE_KEY_COUNT] = {
  ...
  {"MaxRate", "win,web,droid", "setting", "number", "", "", "", "agreed", "100000", "", ""},
  ...
  {"SingleFile", "win,web,droid", "setting", "checkbox", "--single-file", "", "", "agreed", "0", "", ""},
  {"SingleFileMaxSize", "win,web,droid", "setting", "string", "", "", "", "agreed", "", "absent", ""},
  {"Sitemap", "win,web,droid", "setting", "checkbox", "--sitemap", "", "", "agreed", "0", "", ""},
  {"SitemapUrl", "win,web,droid", "setting", "string", "", "", "", "agreed", "", "absent", ""},
  {"Sockets", "win,web,droid", "setting", "number", "", "", "", "agreed", "4", "", ""},
